...
class HarqService < BSPBase
  ...
  param :ackdelay, :bsname => 'harq_ack_delay', :name => '[ackdelay]', :oid => '1.3.6.1.4.1.989.1.16.2.7.3.7.1.6.1.1', :help => 'The H-ARQ ACK delay advertised in the UCD (TLV 171): Integer (50)'
...
class MobileService < BSPBase
  ...
  param :idlemodetimeout, :bsname => 'idle_mode_timeout', :name => '[idlemodetimeout]', :oid => '1.3.6.1.4.1.989.1.16.2.7.3.1.1.16.1', :help => 'Time the BS waits for a DREG-REQ after sending a DREG-CMD in case of un-solicited idle mode initiation. in ms: Integer'
...
class WirelessService < BSPBase
  ...
  param :dlpermutationbase, :bsname => 'downlink_permutation_base', :name => '[dlpermutationbase]', :oid => '1.3.6.1.4.1.989.1.16.2.7.3.1.1.87.1', :help => 'The base used for the sub-carrier permutation in uplink PUSC zones: Integer[0..31] (21)'
