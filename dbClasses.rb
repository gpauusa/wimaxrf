...
class Datapath
  include DataMapper::Resource
  property :interface,  String, :length => 1..20,  :key => true, :required => true, :default => 'eth0'
  property :vlan,       String, :required => true, :key => true
...
class AuthClient
  ...
  property :vlan,       String, :field => 'vlanid'
  property :interface,  String, :length => 1..20, :required => true, :default => 'eth0'
